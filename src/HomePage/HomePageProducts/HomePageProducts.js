    ...
    <div>
      ...
      <div className='border-b-[1px] border-gray-200 my-5 md:my-3'>
        <ul className='w-8/12 md:w-5/12 mx-auto flex justify-between h-40px'>
          ...
          <li className='inline-block'>
            <button onClick={() => handleShowProducts('vegetables')} className='border-b-2 border-transparent font-bold text-gray-500 hover:text-[#8ba73b] hover:border-b-2 hover:border-[#8ba73b] -mb-[1px] py-3 duration-300'>Fruits</button>
          </li>
          <li className='inline-block'>
